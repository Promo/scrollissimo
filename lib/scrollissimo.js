...
(function(_document, _window){
    ...
    _window.addEventListener('load', function(){
        ...
        if(!Scrollissimo._isTouchMode){
            ...
            stepwiseDetector = function(e){
                ...
                console.log(e.deltaY, wheelStack.length);

                if((+new Date - spectateStartTime <= 400)){
                    if(wheelStack.length === 5){
                        for(var i = 0; i < 5; i++){
    ...
    Scrollissimo = {
        ...
        _test: {
            _setRenderFunc: function(newRenderFunc){ Queue.prototype._render = newRenderFunc; },
